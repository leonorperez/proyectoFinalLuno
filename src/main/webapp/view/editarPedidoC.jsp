                ...
                <ul class="nav">
                    ...
                    <li><a href="">Acerca de</a>
                        <ul>
                            ...
                            <li><a href="">Nuestra Misiï¿½n</a></li>
    ...
    <form  action="../controller/updPedidoC.jsp" method="POST" class="needs-validation" novalidate>
      ...
      <div class="row">
        ...
        <div class="col-md-3 mb-3">
          ...
          <div class="invalid-feedback">
            Faltï¿½ ingresar el Cï¿½digo Postal.
          </div>
        </div>
      </div>
      ...
      <div class="d-block my-3">
        <div class="custom-control custom-radio">
          ...
          <label class="custom-control-label" for="credit">Tarjeta de Crï¿½dito</label>
        </div>
        <div class="custom-control custom-radio">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
          <label for="cc-number">Nï¿½mero de la tarjeta</label>
          <input type="text" class="form-control" id="cc-number" name="cc-number" placeholder="" required>
          <div class="invalid-feedback">
            El nï¿½mero es obligatorio.
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-3 mb-3">
          <label for="cc-cvv">Cï¿½digo</label>
