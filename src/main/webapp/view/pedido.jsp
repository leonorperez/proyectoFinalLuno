...
<body class="bg-light">
  <div class="py-4 text-center">
    ...
    <p class="lead">La fecha de entrega ser� coordinada telef�nicamente.</p>
  </div>
    ...
    <form  action="../controller/guardarPedido.jsp" method="POST">
      ...
      <div class="row">
        <div class="col-md-12 mb-3">
	        ...
	        <div class="invalid-feedback">
	          Falt� ingresar el domicilio de entrega.
	        </div>
	      </div>
	   </div>
      ...
      <div class="row">
        <div class="col-md-5 mb-3">
          ...
          <div class="invalid-feedback">
            Seleccion� una localidad v�lida.
          </div>
        </div>
        <div class="col-md-4 mb-3">
          ...
          <select class="custom-select d-block w-100" id="state" name="state" required>
            ...
            <option value="2">Tucum�n</option>
          </select>
          <div class="invalid-feedback">
            Seleccion� una provincia v�lida.
          </div>
        </div>
        <div class="col-md-3 mb-3">
          ...
          <div class="invalid-feedback">
            Falt� ingresar el C�digo Postal.
          </div>
        </div>
      </div>
